...
Entonces, una de las opciones que podemos utilizar para evitar lo de arriba es el paquete `apaTables`. Este paquete genera tablas en formato apa luego de realizar la estadística.
